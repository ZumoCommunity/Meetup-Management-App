...
app.use('/common/js/flatpickr', express.static(path.join(__dirname, 'node_modules', 'flatpickr', 'dist', 'flatpickr.min.js')));
...
app.use('/common/css/flatpickr', express.static(path.join(__dirname, 'node_modules', 'flatpickr', 'dist', 'flatpickr.min.css')));
